    ...
    return Scaffold(  
     body: Column(
          children: [   
            ...
            child: const Divider(color: AppColors.fourthColor,),) , 

            Padding(
              padding:  EdgeInsets.symmetric(horizontal: Get.width*0.1),
              child: Row(children: [
                Text("Market" ,style: Theme.of(context).textTheme.bodyLarge!.
                copyWith(fontSize: Get.width*0.1 , 
              ...
              child: Column(
                children: [
                  Row(children: [
                    ...
                    copyWith(fontSize: Get.width*0.07 , 
                    fontWeight: FontWeight.w300 , 
                    color: AppColors.fourthColor ),)  ,
                  ],),
                    ...
                    CustomButton(onpressed: (){},
                     ...
                     child: Text("Exchange",style: Theme.of(context).textTheme.bodyMedium!
